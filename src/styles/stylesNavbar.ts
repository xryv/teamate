...
export const BurgerList = styled.ul`${tw`md:hidden flex flex-row justify-end items-center w-1/3 pr-[2.9rem]`}
li {
    ${tw`flex w-fit h-fit justify-end items-center shrink-0`}
    }`;

export const StyledUlSideBar = styled.ul`  ${tw`flex flex-col justify-center items-center gap-8 px-6 py-4`}
li {
